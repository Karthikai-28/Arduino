...
#define Gyro_gX0 0x44 
#define Gyro_gX1 0x43
#define Gyro_gY0 0x46
#define Gyro_gY1 0x45
#define Gyro_gZ0 0x48  
#define Gyro_gZ1 0x47
int Gyro = 0x77; //Device address in which is also included the 8th bit for selecting the mode, read in this case.
int gX0, gX1, gX_out;
int gY0, gY1, gY_out;
int gZ0, gZ1, gZ_out;
float Xg,Yg,Zg;
