...
void setup() 
{
  ...
  MoveForward(CMtoSteps(50), 180);  // Forward half a metre at 255 speed
  delay(1000);  // Wait one second
  MoveReverse(10, 150);  // Reverse 10 steps at 255 speed
  delay(1000);  // Wait one second
  MoveForward(10, 150);  // Forward 10 steps at 150 speed
  delay(1000);  // Wait one second
  MoveReverse(CMtoSteps(25.4), 200);  // Reverse 25.4 cm at 200 speed
  delay(1000);  // Wait one second
  SpinRight(20, 150);  // Spin right 20 steps at 255 speed
  delay(1000);  // Wait one second
  SpinLeft(60, 155);  // Spin left 60 steps at 175 speed
  delay(1000);  // Wait one second
  MoveForward(1, 180);  // Forward 1 step at 255 speed
