 ...
 * CONNECTIONS:
 * 
 * Arduino D10  - Motor Driver PWM 1 Input
 * Arduino D4  - Motor Driver DIR 1 Input
 * Arduino D11  - Motor Driver PWM 2 Input
...
CytronMD motor1(PWM_DIR, 10, 4);  // PWM 1 = Pin 3, DIR 1 = Pin 4.
CytronMD motor2(PWM_DIR,11, 7); // PWM 2 = Pin 9, DIR 2 = Pin 10.
